...
if __name__ == "__main__":
    ...
    mock_ch1 = np.sin(2 * np.pi * 45 * t_2560) + np.sin(2 * np.pi * 60 * t_2560) # 45Hz signal + 60Hz hum
    mock_ch2 = np.sin(2 * np.pi * 0.5 * t_1280)                                 # Slow 0.5Hz wave
    mock_ch3 = np.sin(2 * np.pi * 0.2 * t_1280)                                 # Slow 0.2Hz wave
    mock_ch4 = np.sin(2 * np.pi * 7.83 * t_2560) + np.sin(2 * np.pi * 60 * t_2560)# 7.83Hz Schumann resonance + 60Hz hum
